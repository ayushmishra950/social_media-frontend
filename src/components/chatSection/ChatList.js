...
const ChatList = ({ activeTab }) => {
  ...
  return (
    <div className="flex h-full">
      {/* Chat List */}
      <div className={`w-full md:w-1/3 bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] overflow-hidden transition-all duration-300 ease-in-out ml-8 ${
      ...
      {/* Chat Area */}
      {selectedChat ? (
        <div className={`flex-1 flex flex-col bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] ml-8 mr-4 overflow-hidden transform transition-all duration-300 ease-in-out ${
